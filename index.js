...
if(typeof define == 'function' && define.amd){
    ...
    define(['jquery', 'class', 'string', 'droplist', './timepicker'], factory);
    ...
    factory(window.jQuery, window.jQuery.klass, window.jQuery.string, window.jQuery.fn.droplist, window.jQuery.fn.timepicker);
}
})(function($, Class, String, DropList, TimePicker){

var toPad = String.toPad, doc = document;
